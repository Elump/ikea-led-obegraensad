...
// 4x5 numbers (space after number)
std::vector<std::vector<int>> smallNerrowNumbers = {
    //{0x75, 0x55, 0x70}, // 0
    { 0b11101010,
      0b10101010,
      0b11100000},      // 0
...
// 5x6 numbers
std::vector<std::vector<int>> midNumbers = {
    { 0x69, 0x99, 0x96}, // 0
    { 0x22, 0x22, 0x22}, // 1
    { 0x69, 0x12, 0x4f}, // 2
    { 0xf1, 0x21, 0x96}, // 3
...
// 5x7 numbers
std::vector<std::vector<int>> midHighNumbers = {
  { 0b01101001,
    0b10011001,
    0b10011001,
    0b01100000}, // 0
...
// bitCount: 8
std::vector<std::vector<int>> bigModNumbers = {
    {0x3e, 0x63, 0x63, 0x63, 0x63, 0x63, 0x3e}, // 0 w/t dasch
    {0x0C, 0x1C, 0x3C, 0x0C, 0x0C, 0x0C, 0x0C}, // 1 centered
    {0x3e, 0x63, 0x03, 0x0e, 0x18, 0x60, 0x7f}, // 2 starts top low ends buttom straight
    {0x3e, 0x63, 0x03, 0x1f, 0x03, 0x63, 0x3e}, // 3
    {0x63, 0x63, 0x63, 0x3f, 0x03, 0x03, 0x03}, // 4
    {0x7f, 0x60, 0x60, 0x7e, 0x03, 0x63, 0x3e}, // 5 straight top
    {0x3e, 0x63, 0x60, 0x7e, 0x63, 0x63, 0x3e}, // 6
    {0x7f, 0x03, 0x06, 0x0c, 0x18, 0x18, 0x18}, // 7 straight top
    {0x3e, 0x63, 0x63, 0x3e, 0x63, 0x63, 0x3e}, // 8
    {0x3e, 0x63, 0x63, 0x3f, 0x03, 0x03, 0x3e}  // 9 straight buttom
};
